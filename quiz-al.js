...
function checkWinner() {
    if (player1wins > player2wins) {
        qncontainer.text("The winner is Player 1!")
        qnchoices.text("Player 2 must buy Player 1 lunch today!")
    }
    else if (player2wins > player1wins) {
        qncontainer.text("The winner is Player 2!")
        qnchoices.text("Player 1 must buy Player 2 lunch today!")
    }
    else {
        qncontainer.text("It's a draw!")
        qnchoices.text("Go Dutch for lunch today!")
         }
}
updatescore()
